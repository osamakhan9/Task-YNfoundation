...
import styles from "../styles/First_Animation.module.css";
...
const First_Animation = () => {
  return (
    ...
    <video loop muted autoplay="autoplay" className='video_animation'>
       <source src="https://content-management-files.canva.com/943bd1b3-ffd6-4892-a4df-b107cb33e657/hero-banner-en-1600x852.mp4" type=""/>
     </video>
